...
public class TicketSaveReq {
     ...
     * 会员id
     */
    @NotNull(message = "会员id涓嶈兘涓虹┖锛?")
    private Long memberId;

    /**
     * 乘客id
     */
    @NotNull(message = "乘客id涓嶈兘涓虹┖锛?")
    ...
    @NotNull(message = "日期涓嶈兘涓虹┖锛?")
    private Date trainDate;

    /**
     * 车次编号
     */
    @NotBlank(message = "车次编号涓嶈兘涓虹┖锛?")
    private String trainCode;

    /**
     * 箱序
     */
    @NotNull(message = "箱序涓嶈兘涓虹┖锛?")
    private Integer carriageIndex;

    /**
     * 排号|01, 02
     */
    @NotBlank(message = "排号涓嶈兘涓虹┖锛?")
    private String seatRow;

    /**
     * 列号|枚举[SeatColEnum]
     */
    @NotBlank(message = "列号涓嶈兘涓虹┖锛?")
    private String seatCol;

    /**
     * 出发站
     */
    @NotBlank(message = "出发站涓嶈兘涓虹┖锛?")
    ...
    @NotNull(message = "出发时间涓嶈兘涓虹┖锛?")
    private Date startTime;

    /**
     * 到达站
     */
    @NotBlank(message = "到达站涓嶈兘涓虹┖锛?")
     ...
     */
    @JsonFormat(pattern = "HH:mm:ss",timezone = "GMT+8")
    @NotNull(message = "到站时间涓嶈兘涓虹┖锛?")
    private Date endTime;

    /**
     * 座位类型|枚举[SeatTypeEnum]
     */
    @NotBlank(message = "座位类型涓嶈兘涓虹┖锛?")
